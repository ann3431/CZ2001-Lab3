...
public class InsertionVersusMerge
{
	...
	private static final int MAX_ARRAY_SIZE = 1000_000; // 1 million may be too big
	private static final int STEP_SIZE = 1000; // step size may be too small
...
//				Sorter.mergeSort(mergeAscendArray, 0, arraySize-1, mergeAscendResults);
			...
			System.out.println(insertDescendResults);
//			System.out.println(mergeDescendResults);
			System.out.println();
			System.out.println(insertAscendResults);
//			System.out.println(mergeAscendResults);
			System.out.println();
		}
	}
